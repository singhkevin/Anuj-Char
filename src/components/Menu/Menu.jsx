          ...
          <div className="menu-sub-col">
            ...
            <div className="menu-socials">
              <div className="menu-social-item">
                <div className="menu-link-item-holder">
                  <a href="https://www.instagram.com/anujchar/" target="_blank" rel="noreferrer">Instagram</a>
                </div>
              </div>
              <div className="menu-social-item">
                <div className="menu-link-item-holder">
                  <a href="https://www.youtube.com/@AnujChar" target="_blank" rel="noreferrer">YouTube</a>
                </div>
              </div>
              <div className="menu-social-item">
                <div className="menu-link-item-holder">
                  <a href="mailto:mc@anujchar.com">Email</a>
                </div>
              </div>
            </div>
          </div>
