...
import "./Home.css";
import HeroImg from "/home/Hero_img2.JPG?url"
    ...
    <ReactLenis root>
      ...
      <div className="page home">
        ...
        <section className="hobbies">
          ...
          <div className="hobby">
            <Link to="/events/sports-events" className="hobby-link">
              <AnimatedCopy tag="h4" animateOnScroll={true}>
                SPORTS EVENTS
              </AnimatedCopy>
              <FiArrowUpRight className="hobby-icon" />
          ...
          <div className="hobby">
            <Link to="/events/shoots" className="hobby-link">
              <AnimatedCopy tag="h4" animateOnScroll={true}>
                SHOOTS
              </AnimatedCopy>
              <FiArrowUpRight className="hobby-icon" />
          ...
          <div className="hobby">
            <Link to="/events/voices" className="hobby-link">
              <AnimatedCopy tag="h4" animateOnScroll={true}>
                VOICE OVERS
              </AnimatedCopy>
              <FiArrowUpRight className="hobby-icon" />
